					...
					if(m_SlicedSpriteInfo.Count > 0)
					{
						...
						for(int spriteIndex = 0; spriteIndex < m_SlicedSpriteInfo.Count; spriteIndex++)
						{
							for(int childSprite = 0; childSprite < m_SlicedSpriteInfo[spriteIndex].ChildObjects.Count; childSprite++)
							{
								...
								m_SlicedSpriteInfo[spriteIndex].ChildObjects[childSprite].GetComponent<Rigidbody2D>().AddForce(sliceDirection * 200.0f);
								m_SlicedSpriteInfo[spriteIndex].ChildObjects[childSprite].GetComponent<Rigidbody2D>().gravityScale = 2;
								m_SlicedSpriteInfo[spriteIndex].ChildObjects[childSprite].GetComponent<Collider2D>().enabled = false;
								Destroy(m_SlicedSpriteInfo[spriteIndex].ChildObjects[childSprite].gameObject, 3);
							}
						}
